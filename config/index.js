module.exports = {
  ...
  // ]
  DRINK_TIME: [
      { time: '30 20 6 * * *', words: '起床喝水，排毒养颜' },
      { time: '30 13 7 * * *', words: '早上记得吃早饭哦' },
      { time: '30 50 7 * * *', words: '要准备上课啦，要好好听课哦' },
      { time: '30 45 8 * * *', words: '课间休息喽，喝杯水，提神醒脑' },
      { time: '30 40 9 * * *', words: '下课咯，赶紧换教室' },
      { time: '30 45 10 * * *', words: '课间休息喽，想我就给我发消息哦' },
      { time: '30 40 11 * * *', words: '下课了，要乖乖按时吃饭哦' },
      { time: '30 10 12 * * *', words: '听说午餐后喝水，能减负减肥' },
      { time: '30 20 12 * * *', words: 'dear，别忘了英语听力打卡' },
      { time: '30 00 13 * * *', words: '亲爱的，中午要记得午休哦' },
      { time: '30 00 14 * * *', words: '亲爱的，快起床集合了' },
      { time: '30 30 14 * * *', words: '想我要记得给我发消息....o(╯□╰)o' },
      { time: '30 30 17 * * *', words: '据说晚饭前喝杯水，晚上吃的就少了' },
      { time: '30 30 18 * * *', words: '姑娘，快要集合了，快收拾吧' },
      { time: '30 00 19 * * *', words: '姑娘7点到8点要好好学习哦' },
      { time: '30 00 20 * * *', words: '姑娘，学累了吧，休息休息' },
      { time: '30 30 21 * * *', words: '姑娘，该洗澡咯' },
      { time: '30 00 23 * * *', words: '睡觉前也别忘了喝水' }
    ]
}
